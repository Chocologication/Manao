...
The next direction is Java project runtime design before broader multi-language adaptation and AI. On 2026-09-21 the user confirmed persistent MySQL data on a separate PVC, a two-hour application lifetime after successful startup, and public ports restricted to 30000–31000. The [Java Runtime Design](superpowers/specs/2026-09-21-java-project-runtime-design.md) defines expiry, external NodePort mapping, optional dependencies and focused acceptance scenarios. Status: requirements refined in design, not implementation or verification complete. The design owns the details; this index does not add a second acceptance matrix.
