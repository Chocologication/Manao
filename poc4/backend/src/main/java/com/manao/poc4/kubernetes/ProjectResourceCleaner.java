 ...
 * then PVC only after workloads are confirmed gone. Unknown or forbidden lists are never empty.
 */
public final class ProjectResourceCleaner {
    ...
    public CleanupReport clean(String projectId) {
        ...
        Inventory afterWorkloads = inventory(labels, issues);
        ...
        return toReport(inventory(labels, issues), issues);
    }
