...
- immutable matrix source SHA：`2238895039693cd19807a9e0cde4fa89aae42f42`
- 实现提交：`fix(poc4): complete terminal lifecycle contract`
- 矩阵工作目录：`poc4/frontend`
- 包管理器：pnpm `10.33.0`；browser commands 设置 `PLAYWRIGHT_HTML_OPEN=never`
- 权威时间源：`.superpowers/sdd/2026-08-25-ensoai-stage-5-active-job-terminal-implementation-plan/matrix-2238895-summary.json`；逐命令日志位于相邻 `matrix-2238895-logs/`
- 正式 11 命令矩阵、final production rebuild、production scan 与 17 门判定均绑定上述 immutable source SHA
- 矩阵后 tracked diff 精确为 50 张 PNG 且无其他文件；50 张 PNG 已全部恢复到 source SHA；README 未修改
...
|---|---|---:|---:|---|
| `pnpm test:boundary` | `2026-08-25T21:50:15.898+08:00` -> `2026-08-25T21:50:16.859+08:00` | 0.958 s | 0 | node:test **24 pass / 0 fail / 0 skipped**；scanner PASS |
| `pnpm typecheck` | `2026-08-25T21:50:16.891+08:00` -> `2026-08-25T21:50:22.183+08:00` | 5.292 s | 0 | `tsc -b --pretty false` 无诊断 |
| `pnpm test` | `2026-08-25T21:50:22.189+08:00` -> `2026-08-25T21:51:07.696+08:00` | 45.508 s | 0 | Vitest **61 files / 1,121 pass / 0 fail** |
| `pnpm build` | `2026-08-25T21:51:07.701+08:00` -> `2026-08-25T21:51:54.816+08:00` | 47.116 s | 0 | production，**3,787 modules**；保留既有 >500 kB warning |
| `pnpm build:mock` | `2026-08-25T21:51:54.820+08:00` -> `2026-08-25T21:52:42.374+08:00` | 47.555 s | 0 | mock，**3,799 modules**；mock-only `stage0.html` 仅存在于该临时产物 |
| `pnpm test:e2e` | `2026-08-25T21:52:42.378+08:00` -> `2026-08-25T21:54:44.129+08:00` | 121.753 s | 0 | Chromium **66 passed / 18 skipped / 0 failed**；两个 required fixme 各 skip 1 次 |
| `pnpm test:e2e:channels` | `2026-08-25T21:54:44.133+08:00` -> `2026-08-25T21:59:58.383+08:00` | 314.256 s | 0 | Chrome + Edge **164 passed / 4 skipped / 0 failed**；4 skips 为两个 required fixme 各跨两浏览器一次 |
| `pnpm test:e2e:large-files` | `2026-08-25T21:59:58.387+08:00` -> `2026-08-25T22:00:59.663+08:00` | 61.277 s | 0 | **2/2 passed**；20 MiB - 1 Java 与 20 MiB + 1 Markdown |
| `pnpm test:e2e:large-writes` | `2026-08-25T22:00:59.666+08:00` -> `2026-08-25T22:02:03.271+08:00` | 63.606 s | 0 | **1/1 passed**；20 MiB + 1 Markdown PUT |
| `pnpm test:e2e:large-logs` | `2026-08-25T22:02:03.275+08:00` -> `2026-08-25T22:03:19.122+08:00` | 75.848 s | 0 | **1/1 passed**；6,291,522 generated / 5,242,880 retained / 1,048,642 evicted bytes；console/page errors 0/0 |
| `pnpm test:e2e:terminal-stress` | `2026-08-25T22:03:19.129+08:00` -> `2026-08-25T22:04:31.523+08:00` | 72.395 s | 0 | **1/1 passed**；完整 flow/resize/render metrics |
...
E2E 后 final production `pnpm build`：`2026-08-25T22:05:17.407+08:00` -> `2026-08-25T22:06:04.749+08:00`，47.339 s，exit 0，3,787 modules。final `pnpm test:boundary`：`2026-08-25T22:06:13.232+08:00` -> `2026-08-25T22:06:14.193+08:00`，0.958 s，exit 0，24/24。
...
|---|---|
| `dist/assets/index-8OfWs1br.js` | 388,416 bytes；`xterm` literal 0 |
| `dist/assets/WorkbenchPage-BayhnjYv.js` | 4,014,286 bytes；`xterm` literal 0；terminal reference 2 |
| `dist/assets/JobTerminalPanel-DYlPqMRh.js` | dedicated lazy terminal JS，664,452 bytes；`xterm` literal 162 |
...
- 矩阵运行后 tracked diff 精确出现 50 张 PNG 且无其他文件；50 张均恢复到 immutable source SHA，当前没有 tracked PNG diff。
